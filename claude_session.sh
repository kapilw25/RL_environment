...
=====
    ...
    bash claude_session.sh --relocate <old_path>
        # No SSH. The repo moved on this Mac (its slug changed); rewrite the
        # embedded paths and fast-forward-merge old sessions into the new slug.
...
MAC_REPO="/Users/kapilwanaskar/Downloads/research_projects/RL_env"
